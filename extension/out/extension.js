...
function activate(context) {
    ...
    const provider = new chatPanel_1.ChatPanel(context.extensionUri);
    context.subscriptions.push(vscode.window.registerWebviewViewProvider('aiAssistant.chatView', provider));
    ...
    context.subscriptions.push(vscode.commands.registerCommand('aiAssistant.setApiKey', async () => {
        ...
        if (apiKey) {
            await vscode.workspace.getConfiguration('aiAssistant').update('apiKey', apiKey, vscode.ConfigurationTarget.Global);
